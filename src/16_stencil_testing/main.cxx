...
int main() {
  ...
  // -------------------------
  Shader shader("src/16_stencil_testing/shaders/stencil_testing.vs",
                "src/16_stencil_testing/shaders/stencil_testing.fs");
  Shader shaderSingleColor("src/16_stencil_testing/shaders/stencil_testing.vs",
                           "src/16_stencil_testing/shaders/border.fs");
