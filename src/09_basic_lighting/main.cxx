...
Shader set_up_cube() {
  ...
  Shader shaders("src/09_basic_lighting/shaders/shader.vs",
                 "src/09_basic_lighting/shaders/shader.fs");
...
Shader set_up_lights() {
  ...
  Shader shaders("src/09_basic_lighting/shaders/lightingShader.vs",
                 "src/09_basic_lighting/shaders/lightingShader.fs");
