...
Shader set_up_cube() {
  ...
  Shader shaders("src/11_lighting_maps/shaders/shader.vs",
                 "src/11_lighting_maps/shaders/shader.fs");
  ...
  unsigned char *data =
      stbi_load("src/11_lighting_maps/textures/container2.png", &width, &height,
                &nrChannels, 0);
  ...
  data = stbi_load("src/11_lighting_maps/textures/container2_specular.png", &width,
                   &height, &nrChannels, 0);

  glGenTextures(1, &specularMap);
  glActiveTexture(GL_TEXTURE1); // the second texture unit needs explicit activation 
...
Shader set_up_lights() {
  ...
  Shader shaders("src/11_lighting_maps/shaders/lightingShader.vs",
                 "src/11_lighting_maps/shaders/lightingShader.fs");
