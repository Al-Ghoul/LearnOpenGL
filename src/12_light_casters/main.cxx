...
int main() {
  ...
  while (!glfwWindowShouldClose(window)) {
    ...
    cube_shader.setFloat("light.outerCutOff", glm::cos(glm::radians(17.5f)));
...
Shader set_up_cube() {
  ...
  Shader shaders("src/12_light_casters/shaders/shader.vs",
                 "src/12_light_casters/shaders/shader.fs");
  ...
  unsigned char *data =
      stbi_load("src/12_light_casters/textures/container2.png", &width, &height,
                &nrChannels, 0);
  ...
  data = stbi_load("src/12_light_casters/textures/container2_specular.png",
...
Shader set_up_lights() {
  ...
  Shader shaders("src/12_light_casters/shaders/lightingShader.vs",
                 "src/12_light_casters/shaders/lightingShader.fs");
