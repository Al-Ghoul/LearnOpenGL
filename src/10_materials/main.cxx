...
int main() {
  ...
  while (!glfwWindowShouldClose(window)) {
    ...
    cube_shader.setVec3("material.specular", 0.5f, 0.5f, 0.5f);
...
Shader set_up_cube() {
  ...
  Shader shaders("src/10_materials/shaders/shader.vs",
                 "src/10_materials/shaders/shader.fs");
...
Shader set_up_lights() {
  ...
  Shader shaders("src/10_materials/shaders/lightingShader.vs",
                 "src/10_materials/shaders/lightingShader.fs");
